...
local hg_unconscious_ring = CreateClientConVar("hg_unconscious_ring", "1", true, false, "enable the unconscious ring", 0, 1)
...
hg.settings:AddOpt("Gameplay","hg_unconscious_ring", "Unconscious ring")
--hg_gary
--hg_deathfadeout
